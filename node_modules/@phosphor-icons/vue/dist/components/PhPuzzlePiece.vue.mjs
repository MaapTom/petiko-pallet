...
const y = ["width", "height", "fill", "transform"], M = { key: 0 }, f = /* @__PURE__ */ a("path", { d: "M222.4,155.2a11.8,11.8,0,0,0-11.5-.7A16.5,16.5,0,0,1,204,156a15.8,15.8,0,0,1-11.7-5.1,16,16,0,0,1,18.6-25.4A12,12,0,0,0,228,114.7V72a20.1,20.1,0,0,0-20-20H176a40.4,40.4,0,0,0-12.6-29.2A40.1,40.1,0,0,0,96.1,49.1,28.1,28.1,0,0,0,96,52H64A20.1,20.1,0,0,0,44,72v28a40.4,40.4,0,0,0-29.2,12.6,40.1,40.1,0,0,0,26.3,67.3H44v28a20.1,20.1,0,0,0,20,20H208a20.1,20.1,0,0,0,20-20V165.3A11.9,11.9,0,0,0,222.4,155.2ZM204,204H68V165.3a12,12,0,0,0-17.1-10.8,16,16,0,0,1-18.6-25.4A15.8,15.8,0,0,1,44,124a16.5,16.5,0,0,1,6.9,1.5A12,12,0,0,0,68,114.7V76h42.7a12,12,0,0,0,10.8-17.1A16.1,16.1,0,0,1,134.9,36,16.1,16.1,0,0,1,152,52a16.5,16.5,0,0,1-1.5,6.9A12,12,0,0,0,161.3,76H204v24h-2.9a40.1,40.1,0,0,0-26.3,67.3A40.4,40.4,0,0,0,204,180h0Z" }, null, -1), Z = [
  ...
  setup(d) {
    const n = d, h = i("weight", "regular"), _ = i("size", "1em"), A = i("color", "currentColor"), V = i("mirrored", !1), s = r(() => n.weight ?? h), c = r(() => n.size ?? _), H = r(() => n.color ?? A), p = r(() => n.mirrored !== void 0 ? n.mirrored ? "scale(-1, 1)" : void 0 : V ? "scale(-1, 1)" : void 0);
    return (l, G) => (o(), e("svg", u({
      ...
      m(l.$slots, "default"),
      t(s) === "bold" ? (o(), e("g", M, Z)) : t(s) === "duotone" ? (o(), e("g", w, x)) : t(s) === "fill" ? (o(), e("g", S, B)) : t(s) === "light" ? (o(), e("g", P, b)) : t(s) === "regular" ? (o(), e("g", E, $)) : t(s) === "thin" ? (o(), e("g", j, D)) : v("", !0)
    ], 16, y));
  }
});
export {
