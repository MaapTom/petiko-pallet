...
const y = ["width", "height", "fill", "transform"], f = { key: 0 }, w = /* @__PURE__ */ o("path", { d: "M171.4,157.4a12,12,0,0,1,.3,17,12,12,0,0,1-17,.3,38.7,38.7,0,0,0-53.4,0,12,12,0,1,1-16.7-17.3,62.8,62.8,0,0,1,86.8,0ZM217,80l15.5-15.5a12,12,0,0,0-17-17L200,63,184.5,47.5a12,12,0,0,0-17,17L183,80,167.5,95.5a12,12,0,0,0,0,17,12.1,12.1,0,0,0,17,0L200,97l15.5,15.5a12.1,12.1,0,0,0,17,0,12,12,0,0,0,0-17ZM128,184a16,16,0,1,0,16,16A16,16,0,0,0,128,184Zm7.4-115.8a12,12,0,1,0,1.2-24L128,44A157.5,157.5,0,0,0,16.6,89.6a12,12,0,1,0,16.9,17.1A133.7,133.7,0,0,1,128,68Zm-.4,48.1a12.1,12.1,0,0,0,13-11,12,12,0,0,0-11-12.9c-3-.3-6-.4-9-.4a109.6,109.6,0,0,0-77.4,31.6,11.9,11.9,0,0,0-.2,16.9,12.1,12.1,0,0,0,8.6,3.6,11.9,11.9,0,0,0,8.4-3.4A86,86,0,0,1,128,116C130.3,116,132.7,116.1,135,116.3Z" }, null, -1), C = [
  ...
  setup(d) {
    const n = d, _ = l("weight", "regular"), h = l("size", "1em"), p = l("color", "currentColor"), m = l("mirrored", !1), s = i(() => n.weight ?? _), r = i(() => n.size ?? h), A = i(() => n.color ?? p), L = i(() => n.mirrored !== void 0 ? n.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
    return (c, F) => (e(), a("svg", g({
      ...
      u(c.$slots, "default"),
      t(s) === "bold" ? (e(), a("g", f, C)) : t(s) === "duotone" ? (e(), a("g", k, S)) : t(s) === "fill" ? (e(), a("g", z, N)) : t(s) === "light" ? (e(), a("g", W, E)) : t(s) === "regular" ? (e(), a("g", P, $)) : t(s) === "thin" ? (e(), a("g", j, q)) : M("", !0)
    ], 16, y));
  }
});
export {
