import { defineComponent as M, inject as s, computed as A, openBlock as a, createElementBlock as t, mergeProps as g, unref as l, renderSlot as u, createCommentVNode as y, createElementVNode as o } from "vue";
const L = ["width", "height", "fill", "transform"], f = { key: 0 }, w = /* @__PURE__ */ o("path", { d: "M195.7,75.3A32,32,0,0,0,152,63.6a31.7,31.7,0,0,0-6.5,4.9L131,43.4A32,32,0,0,0,87.3,31.7,30.8,30.8,0,0,0,78.6,39,35,35,0,0,0,69,34.6,32,32,0,0,0,33,81.5l.5.9A30.5,30.5,0,0,0,26,85.5a32,32,0,0,0-11.7,43.7l42,72.8a92,92,0,1,0,159.4-92ZM170,214.9A68.1,68.1,0,0,1,77.1,190l-42-72.8a7.9,7.9,0,0,1-.8-6,8.3,8.3,0,0,1,3.7-4.9,8.1,8.1,0,0,1,11,2.9l22,38.1h0l4,6.9a12,12,0,1,0,20.7-12l-42-72.8a8.4,8.4,0,0,1-.8-6,8.1,8.1,0,0,1,3.8-4.9,7.5,7.5,0,0,1,6-.8,8.3,8.3,0,0,1,4.9,3.7l8,13.9h0l13,22.5,21,36.4a12,12,0,0,0,20.8-12l-8-13.9h0l-13-22.5-13-22.5a8,8,0,0,1,13.8-8l30,51.9h0l18,31.2a12,12,0,0,0,20.8-12l-8-13.8h0L161,95.3a8.4,8.4,0,0,1-.8-6,8.1,8.1,0,0,1,3.8-4.9,8,8,0,0,1,10.9,2.9l20,34.7A68.1,68.1,0,0,1,170,214.9ZM144,28V12a12,12,0,0,1,24,0V28a12,12,0,0,1-24,0Zm41.6,4.7,8-13.8a12,12,0,0,1,20.8,12l-8,13.8A12,12,0,0,1,190,49.1,12,12,0,0,1,185.6,32.7Zm59.5,37.7-13.8,8a12,12,0,1,1-12-20.8l13.8-8a12,12,0,0,1,12,20.8Z" }, null, -1), k = [
  w
  ...
  setup(r) {
    const h = r, d = s("weight", "regular"), c = s("size", "1em"), _ = s("color", "currentColor"), Z = s("mirrored", !1), e = A(() => h.weight ?? d), n = A(() => h.size ?? c), m = A(() => h.color ?? _), p = A(() => h.mirrored !== void 0 ? h.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (i, F) => (a(), t("svg", g({
      ...
      u(i.$slots, "default"),
      l(e) === "bold" ? (a(), t("g", f, k)) : l(e) === "duotone" ? (a(), t("g", v, S)) : l(e) === "fill" ? (a(), t("g", z, V)) : l(e) === "light" ? (a(), t("g", N, E)) : l(e) === "regular" ? (a(), t("g", P, $)) : l(e) === "thin" ? (a(), t("g", j, q)) : y("", !0)
    ], 16, L));
  }
});
export {
