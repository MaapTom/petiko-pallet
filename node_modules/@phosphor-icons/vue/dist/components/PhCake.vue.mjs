import { defineComponent as m, inject as n, computed as l, openBlock as a, createElementBlock as o, mergeProps as Z, unref as t, renderSlot as g, createCommentVNode as u, createElementVNode as e } from "vue";
const C = ["width", "height", "fill", "transform"], v = { key: 0 }, M = /* @__PURE__ */ e("path", { d: "M242,112a36,36,0,0,0-36-36H160.3a38.1,38.1,0,0,0,4-11.4c2.3-13.2-2-27.7-12.6-43.1A124.2,124.2,0,0,0,136.2,3.2a12,12,0,0,0-16.4,0,124.2,124.2,0,0,0-15.5,18.3C93.7,36.9,89.4,51.4,91.7,64.6a38.1,38.1,0,0,0,4,11.4H50a36,36,0,0,0-36,36v13.3a47.2,47.2,0,0,0,14,33.4V208a20.1,20.1,0,0,0,20,20H208a20.1,20.1,0,0,0,20-20V158.7a47.2,47.2,0,0,0,14-33.4ZM128,29.8c6.9,8.6,14.3,20.9,12.7,30.7-1,5.4-5.2,10.2-12.7,14.2-7.5-4-11.7-8.8-12.6-14.2C113.6,50.8,121.1,38.5,128,29.8ZM38,112a12,12,0,0,1,12-12H206a12,12,0,0,1,12,12v13.3a23.1,23.1,0,0,1-6.9,16.4,21.4,21.4,0,0,1-15.5,6.3A22.1,22.1,0,0,1,174,126a4.9,4.9,0,0,0-.1-1.2,12,12,0,0,0-23.8,0,4.9,4.9,0,0,0-.1,1.2,22,22,0,0,1-44,0,4.9,4.9,0,0,0-.1-1.2,12,12,0,0,0-23.8,0A4.9,4.9,0,0,0,82,126a22.1,22.1,0,0,1-21.6,22,21.4,21.4,0,0,1-15.5-6.3A23.1,23.1,0,0,1,38,125.3Zm14,92V171.3a52.6,52.6,0,0,0,8.9.7,46.2,46.2,0,0,0,33-15.1,46.1,46.1,0,0,0,68.2,0,46.2,46.2,0,0,0,33,15.1h.9a52.9,52.9,0,0,0,8-.7V204Z" }, null, -1), y = [
  M
  ...
  setup(d) {
    const c = d, h = n("weight", "regular"), _ = n("size", "1em"), A = n("color", "currentColor"), V = n("mirrored", !1), s = l(() => c.weight ?? h), i = l(() => c.size ?? _), H = l(() => c.color ?? A), p = l(() => c.mirrored !== void 0 ? c.mirrored ? "scale(-1, 1)" : void 0 : V ? "scale(-1, 1)" : void 0);
    return (r, G) => (a(), o("svg", Z({
      ...
      g(r.$slots, "default"),
      t(s) === "bold" ? (a(), o("g", v, y)) : t(s) === "duotone" ? (a(), o("g", f, x)) : t(s) === "fill" ? (a(), o("g", S, B)) : t(s) === "light" ? (a(), o("g", N, E)) : t(s) === "regular" ? (a(), o("g", P, $)) : t(s) === "thin" ? (a(), o("g", j, D)) : u("", !0)
    ], 16, C));
  }
});
export {
