...
const Z = ["width", "height", "fill", "transform"], y = { key: 0 }, f = /* @__PURE__ */ e("path", { d: "M240.2,206A27.5,27.5,0,0,1,216,220H157l3.5,3.5a12,12,0,0,1,0,17,12.1,12.1,0,0,1-17,0l-24-24a12.1,12.1,0,0,1,0-17l24-24a12,12,0,0,1,17,17L157,196h59a3.8,3.8,0,0,0,3.4-2,3.8,3.8,0,0,0,0-4l-19.9-34.5a12,12,0,1,1,20.8-12L240.2,178A27.5,27.5,0,0,1,240.2,206ZM128,36a4,4,0,0,1,3.5,2l29.4,50.9-4.7-1.3a12,12,0,1,0-6.2,23.2l32.7,8.8a11.5,11.5,0,0,0,3.1.4,12.1,12.1,0,0,0,11.6-8.9l8.8-32.8A12,12,0,0,0,183,72.1l-1.3,4.8L152.2,26a27.9,27.9,0,0,0-48.4,0l-20,34.4a12,12,0,0,0,20.8,12.1L124.5,38A4,4,0,0,1,128,36ZM80,196H40a3.8,3.8,0,0,1-3.4-2,3.8,3.8,0,0,1,0-4l29.5-51,1.3,4.9a12,12,0,0,0,11.5,8.9,17.5,17.5,0,0,0,3.2-.4,11.9,11.9,0,0,0,8.4-14.7l-8.7-32.8a12.5,12.5,0,0,0-5.6-7.3,12.1,12.1,0,0,0-9.1-1.2l-32.8,8.8a12,12,0,0,0,6.2,23.2l4.7-1.3L15.8,178A28,28,0,0,0,40,220H80a12,12,0,0,0,0-24Z" }, null, -1), w = [
  ...
  setup(d) {
    const s = d, _ = n("weight", "regular"), h = n("size", "1em"), L = n("color", "currentColor"), p = n("mirrored", !1), o = i(() => s.weight ?? _), r = i(() => s.size ?? h), A = i(() => s.color ?? L), g = i(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : p ? "scale(-1, 1)" : void 0);
    return (c, q) => (l(), t("svg", m({
      ...
      u(c.$slots, "default"),
      a(o) === "bold" ? (l(), t("g", y, w)) : a(o) === "duotone" ? (l(), t("g", k, x)) : a(o) === "fill" ? (l(), t("g", S, C)) : a(o) === "light" ? (l(), t("g", B, b)) : a(o) === "regular" ? (l(), t("g", E, V)) : a(o) === "thin" ? (l(), t("g", W, j)) : M("", !0)
    ], 16, Z));
  }
});
export {
