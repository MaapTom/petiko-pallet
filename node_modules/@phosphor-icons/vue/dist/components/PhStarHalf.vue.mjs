import { defineComponent as g, inject as n, computed as c, openBlock as a, createElementBlock as t, mergeProps as A, unref as l, renderSlot as u, createCommentVNode as M, createElementVNode as o } from "vue";
const y = ["width", "height", "fill", "transform"], f = { key: 0 }, V = /* @__PURE__ */ o("path", { d: "M236.6,118.6l-8.8,7.2a11.5,11.5,0,0,1-7.6,2.8,12.2,12.2,0,0,1-9.3-4.3,12,12,0,0,1,1.6-16.9l2.3-2-3-.2a12,12,0,1,1,1.5-23.9l11.6.7A20.5,20.5,0,0,1,243,96.2,20.9,20.9,0,0,1,236.6,118.6Zm-32.4,80.7a12,12,0,1,0-23.2,5.9l.6,2.5-2.2-1.4a12,12,0,0,0-12.8,20.3l9.8,6.2a20.6,20.6,0,0,0,10.9,3.2,19.9,19.9,0,0,0,11.8-3.9,20.6,20.6,0,0,0,7.9-21.9ZM176,137.7a20.9,20.9,0,0,0-6.8,21.1l1.2,4.7a12,12,0,0,0,11.6,9,15.3,15.3,0,0,0,3-.3,12,12,0,0,0,8.6-14.6l-.7-2.7,1.8-1.5a12,12,0,1,0-15.3-18.5ZM140,72.5V181.3l3.1,2a12,12,0,0,1,3.7,16.5,12.1,12.1,0,0,1-16.6,3.8l-2.2-1.5L83.1,230.6a21.7,21.7,0,0,1-24.5-.8A22.4,22.4,0,0,1,50,206.1l13.1-51.2L19.4,118.6A20.9,20.9,0,0,1,13,96.2,20.5,20.5,0,0,1,31.1,82l56.8-3.6,21.2-53.5a20.3,20.3,0,0,1,37.8,0l21.2,53.5h2.3a12,12,0,1,1-1.6,24l-4.5-.3a20.5,20.5,0,0,1-17.6-12.9ZM116,181.3V72.5l-6.7,16.8a20.5,20.5,0,0,1-17.6,12.9l-50.5,3.2L80,137.7a20.9,20.9,0,0,1,6.8,21.1L74.4,207.7Z" }, null, -1), w = [
  V
], S = { key: 1 }, k = /* @__PURE__ */ o("path", {
  ...
  setup(d) {
    const s = d, h = n("weight", "regular"), _ = n("size", "1em"), m = n("color", "currentColor"), L = n("mirrored", !1), e = c(() => s.weight ?? h), i = c(() => s.size ?? _), p = c(() => s.color ?? m), Z = c(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : L ? "scale(-1, 1)" : void 0);
    return (r, F) => (a(), t("svg", A({
      ...
      u(r.$slots, "default"),
      l(e) === "bold" ? (a(), t("g", f, w)) : l(e) === "duotone" ? (a(), t("g", S, x)) : l(e) === "fill" ? (a(), t("g", z, B)) : l(e) === "light" ? (a(), t("g", N, E)) : l(e) === "regular" ? (a(), t("g", P, $)) : l(e) === "thin" ? (a(), t("g", j, q)) : M("", !0)
    ], 16, y));
  }
});
export {
