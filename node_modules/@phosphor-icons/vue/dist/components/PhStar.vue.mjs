...
const f = ["width", "height", "fill", "transform"], M = { key: 0 }, w = /* @__PURE__ */ l("path", { d: "M187.3,236a20.6,20.6,0,0,1-10.9-3.2L128,202.1,83.1,230.6a21.7,21.7,0,0,1-24.5-.8A22.4,22.4,0,0,1,50,206.1l13.1-51.2L19.4,118.6A20.9,20.9,0,0,1,13,96.2,20.5,20.5,0,0,1,31.1,82l56.8-3.6,21.2-53.5a20.3,20.3,0,0,1,37.8,0l21.2,53.5L224.9,82A20.5,20.5,0,0,1,243,96.2a20.9,20.9,0,0,1-6.4,22.4l-43.7,36.3L207,210.2a20.6,20.6,0,0,1-7.9,21.9A19.9,19.9,0,0,1,187.3,236Zm2-23.5Zm-61.3-35a19.9,19.9,0,0,1,10.8,3.1h0l42.8,27.1-12.4-48.9a20.9,20.9,0,0,1,6.8-21.1l38.8-32.3-50.5-3.2a20.5,20.5,0,0,1-17.6-12.9L128,42.3l-18.7,47a20.5,20.5,0,0,1-17.6,12.9l-50.5,3.2L80,137.7a20.9,20.9,0,0,1,6.8,21.1L74.4,207.7l42.8-27.1A19.9,19.9,0,0,1,128,177.5Zm-2,23.4Z" }, null, -1), k = [
  ...
  setup(h) {
    const s = h, d = n("weight", "regular"), _ = n("size", "1em"), L = n("color", "currentColor"), p = n("mirrored", !1), e = c(() => s.weight ?? d), i = c(() => s.size ?? _), A = c(() => s.color ?? L), g = c(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : p ? "scale(-1, 1)" : void 0);
    return (r, G) => (t(), o("svg", u({
      ...
      y(r.$slots, "default"),
      a(e) === "bold" ? (t(), o("g", M, k)) : a(e) === "duotone" ? (t(), o("g", S, z)) : a(e) === "fill" ? (t(), o("g", C, N)) : a(e) === "light" ? (t(), o("g", b, P)) : a(e) === "regular" ? (t(), o("g", V, $)) : a(e) === "thin" ? (t(), o("g", j, D)) : Z("", !0)
    ], 16, f));
  }
});
export {
