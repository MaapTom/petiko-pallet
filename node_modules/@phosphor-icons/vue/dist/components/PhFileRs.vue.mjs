...
const g = ["width", "height", "fill", "transform"], u = { key: 0 }, y = /* @__PURE__ */ e("path", { d: "M220.5,83.5l-56-56A12.3,12.3,0,0,0,156,24H52A20.1,20.1,0,0,0,32,44v80a12,12,0,0,0,24,0V48h80v52a12,12,0,0,0,12,12h52v96H180a12,12,0,0,0,0,24h24a20.1,20.1,0,0,0,20-20V92A12.3,12.3,0,0,0,220.5,83.5ZM160,57l31,31H160ZM52,152H36a12,12,0,0,0-12,12v56a12,12,0,0,0,24,0v-4h4l3.1-.2,6.8,10.7a12,12,0,1,0,20.2-13l-5.7-8.8A32,32,0,0,0,52,152Zm-4,24h4a8,8,0,0,1,0,16H48Zm104,29.4c0,16.2-11.4,26.6-29,26.6a36.2,36.2,0,0,1-23.2-8.8h0a12,12,0,0,1,8.2-20.8,12,12,0,0,1,8.2,3.2H116a12,12,0,0,0,7,2.5c3.1,0,4.5-.6,4.8-.8a3.7,3.7,0,0,0,.2-1.4c-1.6-1-5.4-2.1-7.8-2.8-8.5-2.5-24.2-7.2-24.2-24.4,0-15.4,11.4-26.6,27-26.6a36.2,36.2,0,0,1,23.2,8.8h0a12,12,0,0,1-8.2,20.8,12,12,0,0,1-8.2-3.2h.2a12,12,0,0,0-7-2.5c-2.3,0-2.8.6-3,1.6,1.7.8,4.9,1.7,7,2.4C135.8,182.6,152,187.4,152,205.4Z" }, null, -1), f = [
  ...
  setup(r) {
    const h = r, d = c("weight", "regular"), _ = c("size", "1em"), H = c("color", "currentColor"), A = c("mirrored", !1), s = n(() => h.weight ?? d), l = n(() => h.size ?? _), Z = n(() => h.color ?? H), p = n(() => h.mirrored !== void 0 ? h.mirrored ? "scale(-1, 1)" : void 0 : A ? "scale(-1, 1)" : void 0);
    return (i, D) => (t(), o("svg", M({
      ...
      V(i.$slots, "default"),
      a(s) === "bold" ? (t(), o("g", u, f)) : a(s) === "duotone" ? (t(), o("g", C, k)) : a(s) === "fill" ? (t(), o("g", x, B)) : a(s) === "light" ? (t(), o("g", N, E)) : a(s) === "regular" ? (t(), o("g", P, $)) : a(s) === "thin" ? (t(), o("g", j, R)) : m("", !0)
    ], 16, g));
  }
});
export {
