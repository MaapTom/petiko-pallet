import { defineComponent as g, inject as n, computed as i, openBlock as t, createElementBlock as l, mergeProps as u, unref as a, renderSlot as V, createCommentVNode as Z, createElementVNode as o } from "vue";
const y = ["width", "height", "fill", "transform"], f = { key: 0 }, M = /* @__PURE__ */ o("path", { d: "M124,208a12,12,0,0,1-12,12H40a20.1,20.1,0,0,1-20-20V64A20.1,20.1,0,0,1,40,44H93.3a19.9,19.9,0,0,1,12,4L132,68h84a20.1,20.1,0,0,1,20,20v24a12,12,0,0,1-24,0V92H130.7a19.9,19.9,0,0,1-12-4L92,68H44V196h68A12,12,0,0,1,124,208Zm119.6-37.1-20.5,17,6.2,25.2a11.9,11.9,0,0,1-4.5,12.5,11.7,11.7,0,0,1-7.1,2.4,11.3,11.3,0,0,1-6.1-1.7L188,212.5l-23.6,13.8a12,12,0,0,1-17.7-13.2l6.2-25.2-20.5-17a12.1,12.1,0,0,1,6.7-21.3l27.4-2.1L177,123.2a12,12,0,0,1,22,0l10.5,24.3,27.4,2.1a12.1,12.1,0,0,1,6.7,21.3Zm-38.2.4-5-.4a12,12,0,0,1-10.1-7.2l-2.3-5.4-2.3,5.4a12,12,0,0,1-10.1,7.2l-5,.4,3.4,2.9a11.6,11.6,0,0,1,4,12.1l-1.2,4.9,5.1-3a11.8,11.8,0,0,1,12.2,0l5.1,3-1.2-4.9a11.6,11.6,0,0,1,4-12.1Z" }, null, -1), v = [
  M
  ...
  setup(c) {
    const s = c, h = n("weight", "regular"), _ = n("size", "1em"), p = n("color", "currentColor"), m = n("mirrored", !1), e = i(() => s.weight ?? h), r = i(() => s.size ?? _), H = i(() => s.color ?? p), L = i(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
    return (d, D) => (t(), l("svg", u({
      ...
      V(d.$slots, "default"),
      a(e) === "bold" ? (t(), l("g", f, v)) : a(e) === "duotone" ? (t(), l("g", A, S)) : a(e) === "fill" ? (t(), l("g", x, C)) : a(e) === "light" ? (t(), l("g", B, b)) : a(e) === "regular" ? (t(), l("g", E, W)) : a(e) === "thin" ? (t(), l("g", $, F)) : Z("", !0)
    ], 16, y));
  }
});
export {
