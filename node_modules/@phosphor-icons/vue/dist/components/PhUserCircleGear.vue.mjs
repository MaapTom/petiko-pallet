...
const y = ["width", "height", "fill", "transform"], f = { key: 0 }, v = /* @__PURE__ */ t("path", { d: "M169.6,46.1a12,12,0,0,1,15.1-7.7l3.3,1.1V36a12,12,0,0,1,24,0v3.5l3.3-1.1a12,12,0,0,1,7.4,22.8l-3.3,1.1,2.1,2.8a12,12,0,0,1-2.7,16.8A12,12,0,0,1,202,79.2l-2-2.8-2,2.8a12,12,0,0,1-19.5-14.1l2.1-2.8-3.3-1.1A11.9,11.9,0,0,1,169.6,46.1ZM201,207.5a11.4,11.4,0,0,1-1.6,1.5,107.9,107.9,0,0,1-142.8,0,11.4,11.4,0,0,1-1.6-1.5A107.9,107.9,0,0,1,128,20c3.3,0,6.7.2,10,.5a12,12,0,0,1,10.9,13,12.1,12.1,0,0,1-13.1,10.9A67.9,67.9,0,0,0,128,44,83.9,83.9,0,0,0,62.1,179.9,84,84,0,0,1,91,156.5a52,52,0,1,1,74,0,84,84,0,0,1,28.9,23.4A83.4,83.4,0,0,0,212,128a84.3,84.3,0,0,0-.6-10.1,12,12,0,0,1,23.8-2.8A110.3,110.3,0,0,1,236,128,107.7,107.7,0,0,1,201,207.5ZM128,148a28,28,0,1,0-28-28A28.1,28.1,0,0,0,128,148Zm0,64a83.5,83.5,0,0,0,48.4-15.4,59.9,59.9,0,0,0-96.8,0A83.5,83.5,0,0,0,128,212Z" }, null, -1), w = [
  ...
  setup(A) {
    const s = A, d = n("weight", "regular"), _ = n("size", "1em"), h = n("color", "currentColor"), Z = n("mirrored", !1), l = i(() => s.weight ?? d), r = i(() => s.size ?? _), p = i(() => s.color ?? h), m = i(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (c, F) => (o(), e("svg", M({
      ...
      u(c.$slots, "default"),
      a(l) === "bold" ? (o(), e("g", f, w)) : a(l) === "duotone" ? (o(), e("g", k, S)) : a(l) === "fill" ? (o(), e("g", z, N)) : a(l) === "light" ? (o(), e("g", b, P)) : a(l) === "regular" ? (o(), e("g", W, j)) : a(l) === "thin" ? (o(), e("g", G, q)) : V("", !0)
    ], 16, y));
  }
});
export {
