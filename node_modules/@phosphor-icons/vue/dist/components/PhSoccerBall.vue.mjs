import { defineComponent as L, inject as h, computed as Z, openBlock as t, createElementBlock as o, mergeProps as p, unref as l, renderSlot as g, createCommentVNode as u, createElementVNode as e } from "vue";
const y = ["width", "height", "fill", "transform"], f = { key: 0 }, V = /* @__PURE__ */ e("path", { d: "M236,128A108,108,0,1,0,63.8,214.8l.7.6.9.5a107.5,107.5,0,0,0,125.2,0l.9-.5.7-.6A107.8,107.8,0,0,0,236,128Zm-49.5,60.2L173,169.5l15.8-48.7,22-7.1a84.1,84.1,0,0,1-24.3,74.5ZM105,159.7,90.8,115.9l37.2-27,37.2,27L151,159.7Zm98.3-68.8L181.4,98,140,67.9v-23A84.2,84.2,0,0,1,203.3,90.9ZM116,44.9v23L74.6,98,52.7,90.9A84.2,84.2,0,0,1,116,44.9ZM44,128a84.5,84.5,0,0,1,1.2-14.3l22,7.1L83,169.5,69.5,188.2A83.8,83.8,0,0,1,44,128Zm44.9,74.3,13.5-18.6h51.2l13.5,18.6a83.7,83.7,0,0,1-78.2,0Z" }, null, -1), H = [
  V
  ...
  setup(i) {
    const s = i, r = h("weight", "regular"), d = h("size", "1em"), A = h("color", "currentColor"), _ = h("mirrored", !1), a = Z(() => s.weight ?? r), n = Z(() => s.size ?? d), M = Z(() => s.color ?? A), m = Z(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (c, F) => (t(), o("svg", p({
      ...
      g(c.$slots, "default"),
      l(a) === "bold" ? (t(), o("g", f, H)) : l(a) === "duotone" ? (t(), o("g", v, S)) : l(a) === "fill" ? (t(), o("g", x, B)) : l(a) === "light" ? (t(), o("g", C, b)) : l(a) === "regular" ? (t(), o("g", E, W)) : l(a) === "thin" ? (t(), o("g", $, q)) : u("", !0)
    ], 16, y));
  }
});
export {
