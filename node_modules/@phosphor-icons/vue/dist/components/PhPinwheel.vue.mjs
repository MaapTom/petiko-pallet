...
const y = ["width", "height", "fill", "transform"], f = { key: 0 }, w = /* @__PURE__ */ a("path", { d: "M232.5,215.5l-43.9-43.9a64,64,0,0,0,35.6-81,12,12,0,0,0-15.4-7.2l-35.7,13A64,64,0,0,0,90.6,15.8a12,12,0,0,0-7.2,15.4l13,35.7a64,64,0,0,0-80.6,82.5,12.2,12.2,0,0,0,6.2,6.8,12.6,12.6,0,0,0,5.1,1.1,12.2,12.2,0,0,0,4.1-.7l35.7-13a63.9,63.9,0,0,0,82.5,80.6,12,12,0,0,0,7.2-15.4l-13-35.7a60.9,60.9,0,0,0,15.7,3.2l56.2,56.2a12.1,12.1,0,0,0,17,0A12,12,0,0,0,232.5,215.5ZM129.4,39.7a39.8,39.8,0,0,1,19.3,53.1,38.6,38.6,0,0,1-11.9,14.9L110.7,35.9A39.8,39.8,0,0,1,129.4,39.7ZM39.7,110.6A39.8,39.8,0,0,1,62.2,89.9a40.8,40.8,0,0,1,13.7-2.4,40.1,40.1,0,0,1,16.9,3.8,38.6,38.6,0,0,1,14.9,11.9L35.9,129.3A39.5,39.5,0,0,1,39.7,110.6Zm70.9,89.7a39.8,39.8,0,0,1-19.3-53.1,38.6,38.6,0,0,1,11.9-14.9l26.1,71.8A39.8,39.8,0,0,1,110.6,200.3Zm21.7-63.5,71.8-26.1a40.4,40.4,0,0,1-26.3,39.4,43.9,43.9,0,0,1-13.3,2.4h-.1a39.9,39.9,0,0,1-17.2-3.8A38.6,38.6,0,0,1,132.3,136.8Z" }, null, -1), k = [
  ...
  setup(c) {
    const s = c, h = n("weight", "regular"), _ = n("size", "1em"), A = n("color", "currentColor"), Z = n("mirrored", !1), l = i(() => s.weight ?? h), r = i(() => s.size ?? _), m = i(() => s.color ?? A), p = i(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (d, G) => (o(), e("svg", g({
      ...
      u(d.$slots, "default"),
      t(l) === "bold" ? (o(), e("g", f, k)) : t(l) === "duotone" ? (o(), e("g", v, z)) : t(l) === "fill" ? (o(), e("g", C, N)) : t(l) === "light" ? (o(), e("g", P, E)) : t(l) === "regular" ? (o(), e("g", V, $)) : t(l) === "thin" ? (o(), e("g", j, D)) : L("", !0)
    ], 16, y));
  }
});
export {
