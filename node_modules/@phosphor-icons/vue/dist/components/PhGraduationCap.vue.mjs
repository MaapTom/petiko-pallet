import { defineComponent as Z, inject as n, computed as c, openBlock as o, createElementBlock as e, mergeProps as g, unref as t, renderSlot as u, createCommentVNode as v, createElementVNode as a } from "vue";
const M = ["width", "height", "fill", "transform"], y = { key: 0 }, f = /* @__PURE__ */ a("path", { d: "M249.8,85.5l-116-64a12,12,0,0,0-11.6,0l-116,64a12,12,0,0,0,0,21L20,114.1v51.1a20.3,20.3,0,0,0,4.7,12.9C33.8,188.9,68.2,224,128,224a138.8,138.8,0,0,0,46-7.6V240a12,12,0,0,0,24,0V205.5a132.2,132.2,0,0,0,33.3-27.4,20.3,20.3,0,0,0,4.7-12.9V114.1l13.8-7.6a12,12,0,0,0,0-21ZM128,45.7,219.2,96l-.9.5h-.1L186,114.3,133.8,85.5a12,12,0,1,0-11.6,21l39,21.5L128,146.3,37.8,96.5h-.1l-.9-.5ZM128,200c-47.6,0-75.3-26.4-84-36.3V127.4l78.2,43.1a12,12,0,0,0,11.6,0L174,148.3v42.5A116.7,116.7,0,0,1,128,200Zm84-36.3a99.8,99.8,0,0,1-14,13V135.1l14-7.7Z" }, null, -1), C = [
  f
  ...
  setup(d) {
    const s = d, h = n("weight", "regular"), _ = n("size", "1em"), m = n("color", "currentColor"), p = n("mirrored", !1), l = c(() => s.weight ?? h), i = c(() => s.size ?? _), V = c(() => s.color ?? m), L = c(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : p ? "scale(-1, 1)" : void 0);
    return (r, F) => (o(), e("svg", g({
      ...
      u(r.$slots, "default"),
      t(l) === "bold" ? (o(), e("g", y, C)) : t(l) === "duotone" ? (o(), e("g", w, x)) : t(l) === "fill" ? (o(), e("g", S, B)) : t(l) === "light" ? (o(), e("g", N, E)) : t(l) === "regular" ? (o(), e("g", P, $)) : t(l) === "thin" ? (o(), e("g", j, q)) : v("", !0)
    ], 16, M));
  }
});
export {
